...
<div class="navbar">
  ...
  <div class="nav-item" on:click={() => navigate('Modules')}>
    <!-- Modules Icon Image -->
  ...
  <div class="nav-item" on:click={() => navigate('Account')}>
    <!-- Account Icon Image -->
